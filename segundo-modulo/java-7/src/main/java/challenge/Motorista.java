...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        ...
        if(habilitacao == null)
            throw new NullPointerException("O motorista precisa ser habilitado. Informe sua habilitação.");
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if(idade < 0)
                throw new IllegalArgumentException("A idade não pode ser um valor negativo.");
            this.idade = idade;
            return this;
        }
        ...
        public MotoristaBuilder withPontos(int pontos) {
            if(pontos < 0)
                throw new IllegalArgumentException("Os pontos da carteira não podem ser negativos.");
            this.pontos = pontos;
            return this;
        }
